...
function CreateContextWithSendConsumption(C) {
  var state = [C[/* defaultValue */ 1]];
  var subscriptions = [/* [] */ 0];
  var addSubscription = function(f) {
    subscriptions[0] = /* :: */ [f, subscriptions[0]];
  ...
  var containerSend = [/* None */ 0];
  var setContainerSend = function(send) {
    containerSend[0] = send;
    return /* () */ 0;
  };
  var component = ReasonReact.statelessComponent(
    C[/* name */ 0] + "ContextProvider"
  );
  var make$1 = function(value, send, children) {
    var newrecord = component.slice();
    newrecord[/* willReceiveProps */ 3] = function() {
      containerSend[0] = /* Some */ [send];
      return updateState(value);
    };
    newrecord[/* didMount */ 4] = function() {
      containerSend[0] = /* Some */ [send];
  ...
  var Provider = /* module */ [/* component */ component, /* make */ make$1];
  var component$1 = ReasonReact.reducerComponent(
    C[/* name */ 0] + "ContextConsumerWithSelf"
  );
  var make$2 = function(children) {
    var newrecord = component$1.slice();
    newrecord[/* render */ 9] = function(param) {
      var match = containerSend[0];
      if (match) {
        return Curry._2(children, param[/* state */ 2], match[0]);
      } else {
        return null;
      }
    };
  ...
  return /* module */ [
    ...
    /* setContainerSend */ setContainerSend,
    /* Provider */ Provider,
    /* Consumer */ Consumer
  ];
}
...
exports.CreateContextWithSendConsumption = CreateContextWithSendConsumption;

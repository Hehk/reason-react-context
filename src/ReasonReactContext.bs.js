...
function CreateContext(C) {
  ...
  var component = ReasonReact.statelessComponent(C[/* name */0] + "ContextProvider");
  var make = function (value, children) {
    ...
    newrecord[/* render */9] = (function () {
        return ReasonReact.createDomElement("div", { }, children);
      });
    return newrecord;
  };
  var Provider = /* module */[
  ...
  var component$1 = ReasonReact.reducerComponent(C[/* name */0] + "ContextConsumer");
